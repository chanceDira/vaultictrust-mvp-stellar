...
function TokenizeModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
      <div className="bg-base-100 border border-base-300 rounded-2xl w-full max-w-lg shadow-2xl overflow-y-auto max-h-[95vh]">
        {/* Header */}
        <div className="flex justify-between items-start p-6 pb-4 border-b border-base-300">
          <div>
            ...
            <p className="text-sm text-base-content/60 mt-0.5">
              Open an investment pool for{" "}
              <span className="text-primary font-semibold">{asset.asset_name}</span>
            </p>
          </div>
        ...
        <div className="p-6 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <p className="font-semibold text-sm mt-0.5 text-primary">
                  {registrationValuationUsdc > 0
                    ? `$${registrationValuationUsdc.toLocaleString()} USDC`
                    : "—"}
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="form-control w-full">
              <label className="label pb-1">
                <span className="label-text font-semibold">Total Shares <span className="text-error">*</span></span>
              </label>
              <input
            ...
            <div className="form-control w-full">
              <label className="label pb-1">
                <span className="label-text font-semibold">Price per Share <span className="text-error">*</span></span>
                <span className="label-text-alt text-base-content/40">USDC</span>
              </label>
              <div className="relative">
                <span className="absolute left-4 top-1/2 -translate-y-1/2 text-base-content/50 font-semibold pointer-events-none text-sm">$</span>
                <input
          ...
          {totalPoolUsdc > 0 && (
            <div className="flex items-center justify-between p-3 rounded-xl bg-success/5 border border-success/20">
              <span className="text-xs font-semibold text-base-content/60 uppercase tracking-widest">Total Pool Value</span>
          ...
          <div className="form-control w-full">
            ...
            />
            <label className="label pt-1">
              <span className="label-text-alt text-base-content/40">Maximum number of shares a single investor can hold. Leave blank for no limit.</span>
            </label>
          </div>
          ...
          <div className="form-control w-full">
            ...
            <label className="label pt-1">
              <span className="label-text-alt text-base-content/40">
                The Stellar account that will issue and distribute native <span className="font-mono">{asset.asset_code}</span> tokens to investors
              </span>
            </label>
          </div>
        </div>
